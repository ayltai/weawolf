...
describe('UnsplashApiClient', () => {
    it('getRandomPhoto', async () => {
        const json = await UnsplashApiClient.getRandomPhoto(query, width, height);

        expect(json.urls.regular).toEqual('https://images.unsplash.com/photo-1518472803163-8d3a9e90792c?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=320&h=822&fit=max&ixid=eyJhcHBfaWQiOjI0NDM4fQ');
    });
});
